...
<html lang="en">
    <head>
        ...
        <title>Văn phòng phẩm ABC</title>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="?action=gioithieu">Giới thiệu</a></li>
                    ...
                    <?php if(isset($_SESSION["khachhang"])){ ?>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li class="nav-item"><a class="nav-link text-warning" href="index.php?action=thongtin&kh=<?php echo $_SESSION["khachhang"]["email"]; ?>" >Chào <?php echo $_SESSION["khachhang"]["hoten"]; ?></a></li>
                    ...
                    <?php } else{ ?>
                        ...
                        <a href="index.php?action=dangky" class="btn btn-warning">
